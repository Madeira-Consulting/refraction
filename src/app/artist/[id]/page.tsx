...
export default function Artist({ params }: any) {
  ...
  useEffect(() => {
    (async () => {
      ...
      const setsPromise = await getSets(artistId);
      setSets(setsPromise);
            ...
            <div className="flex flex-row gap-12">
              ...
              <div className="flex flex-col justify-center gap-5">
                ...
                <div className="text-2xl">
                  ...
                  amet consectetur adipisicing elit. Aliquid quo dolorum sed
                  nemo optio assumenda unde sint sit doloremque, ipsam animi
                  veritatis deserunt autem laudantium similique aspernatur
                  dolor. Ratione, nemo.
                </div>
                ...
                <div className="flex flex-row flex-1 overflow-x-scroll gap-5 duration-500 py-5 no-scrollbar">
                  {events.length > 0
                    ? events.map((event: any) => {
                        return (
                          <div className="aspect-video h-32 rounded-3xl bg-dark2 flex flex-row items-center justify-center">
                            <Image
                              unoptimized={true}
                              src={
                                "http://localhost:8090/api/files/" +
          ...
          <div className="col-span-3 flex flex-col gap-16">
            <div className="flex flex-col gap-5">
              <div className="flex flex-row gap-4 items-center pb-2">
                <span className="text-3xl font-bold">Weekly Show</span>{" "}
                {/* <IoIosArrowForward
                  size={20}
              ...
              <div className="flex flex-row gap-5 items-center">
                ...
                <div className="flex flex-col">
                  {" "}
                  <span className="text-xl font-bold">Heldeep Radio</span>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-row gap-5 items-center">
                ...
                <div className="flex flex-col">
                  {" "}
                  <span className="text-xl font-bold">EDC Mexico 2022</span>
                  <span className="text-md font-medium">
