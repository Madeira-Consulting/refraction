...
export default function Set({ params }: any) {
    ...
    return (
        <div
            className="flex flex-row w-screen bg-cover bg-blur duration-500"
            style={{
                backgroundImage:
        ...
        >
            ...
            <div
                className={
                    "w-full h-full z-40 pt-24 bg-gradient-to-r from-dark1 to-dark1/95 pb-40"
                }
            >
                        ...
                        <div className="grid grid-cols-10 gap-x-10 gap-y-10">
                            <div className="col-span-7 aspect-video">
                                {set?.videoURL ? (
                                    <VideoPlayer
                                        cover={
                                            "http://localhost:8090/api/files/oo8jxhoo8efsvqh/" +
                                            setId +
                                            "/" +
                                            set?.thumbnail
                                        }
